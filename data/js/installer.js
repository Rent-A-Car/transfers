...
.pwa-install-prompt__guide__icon {
	...
	switch(type){
		...
		break;
		case 2:
		install_guide='<p class="pwa-install-prompt__guide"></p>'
		break;
		case 3:
		...
		break;
		case 4:
		install_guide='<p class="pwa-install-prompt__guide"><button class="btn btn-outline-success" onclick="window.open(location.href, \'_system\', \'location=yes\');">Open in Safari</button></p>'
		break;
		case 5:
...
}else if(isIDevice && ua.indexOf("safari") > -1 && ua.indexOf("criOS") < 0 && !isFirefox){
